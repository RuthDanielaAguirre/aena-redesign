...
export const t = {
  es: {
    seo: {
      ...
      ogImage:
        'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=1200&h=630&q=65&fm=webp',
    },
    a11y: {
    ...
    vip: {
      ...
      cards: [
        { tag: 'Gastronomía', title: 'Bar y catering premium', desc: 'Bebidas, snacks y menús de temporada incluidos en tu acceso', img: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=500&q=55&fm=webp', aria: 'Gastronomía en sala VIP' },
        { tag: 'Confort', title: 'Zona de descanso', desc: 'Sillones ergonómicos, silencio y temperatura perfecta para desconectar', img: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=500&q=55&fm=webp', aria: 'Zona de descanso VIP' },
        { tag: 'Conectividad', title: 'Wifi de alta velocidad', desc: 'Trabaja o navega sin límites con conexión premium y puertos de carga', img: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=500&q=55&fm=webp', aria: 'Conectividad en sala VIP' },
      ],
    },
    info: {
  ...
  en: {
    ...
    vip: {
      ...
      cards: [
        { tag: 'Gastronomy', title: 'Premium bar & catering', desc: 'Drinks, snacks and seasonal menus included with your access', img: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=500&q=55&fm=webp', aria: 'VIP lounge gastronomy' },
        { tag: 'Comfort', title: 'Rest area', desc: 'Ergonomic chairs, silence and the perfect temperature to unwind', img: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=500&q=55&fm=webp', aria: 'VIP rest area' },
        { tag: 'Connectivity', title: 'High-speed WiFi', desc: 'Work or browse without limits with premium connection and charging ports', img: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=500&q=55&fm=webp', aria: 'VIP lounge connectivity' },
      ],
    },
    info: {
